...
UserModel::UserModel(int num_options, double action_timestep) : random_generator(rd()), random_distribution(0.0, 1.0)
{ 
...
void UserModel::RandomSample(boost::shared_ptr<MotionState> state, std::vector<double>* sample)
{
